	...
	<!-- <nav class="navbar-default navbar-side" role="navigation" style="left: -260px;">
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				<li><a class="active-menu waves-effect waves-dark" href="index.php"><i class="fa fa-dashboard"></i> เมนู </a></li>
				...
				<li><a href="bpreport.php" target="_blank" class="waves-effect waves-dark"><i class="fa fa-edit"></i> Report </a></li>
			</ul>
		</div>
	</nav> -->
